...
public class tictactoe2Player implements Initializable {
    ...
    @FXML
    private Label xturn,l2;
    @FXML
    private Label oturn;
    @FXML
    private Label result;
    @FXML
    private Label name1,name2,info;
    private int playerturn=0;
    private ArrayList<Button> buttons;
    // private String id;
    private int match_no = 1;

    Player_name_Controller obj=new Player_name_Controller();
    ...
    //     name1.setText(obj.p1_name);
    // name2.setText(obj.p2_name);
    }
    ...
    public void SetInfo(String id,String p1,String p2){
        name1.setText(p1);
        name2.setText(p2);
        info.setText("Match_no" + match_no + "ID" + id);
